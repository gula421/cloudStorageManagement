...
public class UserService {
    ...
    public int createUser(User user){
        System.out.println("enter UserService.createUser. Username="+user.getUsername());
    ...
    public Integer getUserIdByName(String username) {return userMapper.getUserIdByName(username);}
}
